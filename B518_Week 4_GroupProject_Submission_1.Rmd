...
# Read directly from OWID's public CSV (no local copy)
owid_csv <- "https://covid.ourworldindata.org/data/owid-covid-data.csv"
data1 <- readr::read_csv(owid_csv, show_col_types = FALSE, progress = FALSE)
